...
import com.example.drinkwaterreminder.sync.ReminderUtils;
...
//            Update the UI using your showCharging method
    ...
    private void updateWaterCount() {
        ...
        if (waterCount > 0 && waterCount < 14){
            mImageButton.setColorFilter( Color.parseColor( c[waterCount] ) );
        }else if (waterCount >= 14 ){
            mImageButton.setColorFilter( Color.parseColor( c[13] ) );}
    ...
    public void incrementWater(View view) {
        ...
        mToast = Toast.makeText(this, R.string.water_drinking_toast, Toast.LENGTH_SHORT);
        mToast.show();
    ...
    private void showCharging(boolean isCharging){
        if (isCharging) {
            mChargingImageView.setImageResource(R.drawable.ic_power_on_charge);

        } else {
            mChargingImageView.setImageResource( R.drawable.ic_power_off_charge);
        }
    }
